...
const client = new ApolloClient({
  uri: "https://ec2-52-79-207-139.ap-northeast-2.compute.amazonaws.com:8080/graphql/",
  ...
  request: async operation => {
    ...
    if (csrf === undefined) {
      let csrftoken = await fetch("https://ec2-52-79-207-139.ap-northeast-2.compute.amazonaws.com:8080/csrf/")
